...
namespace Unity.VisualScripting
{
    ...
    public sealed class Member : ISerializationCallbackReceiver
    {
        ...
        public void Reflect()
        {
            ...
            var reflectedMemberType = memberType ?? throw new InvalidOperationException("No member type was resolved.");

            switch (reflectedMemberType)
            {
                ...
                default:
                    throw new UnexpectedEnumValueException<MemberTypes>(reflectedMemberType);
            }

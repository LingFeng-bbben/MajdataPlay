...
namespace UnityEngine.TestTools
{
    ...
    public class ConditionalIgnoreAttribute : NUnitAttribute, IApplyToTest
    {
        ...
        //With domain reload: the static field is naturally reset to a fresh
        //Dictionary on each domain reload, so [InitializeOnLoad] starts clean
        // With Fast Enter Play Mode: [InitializeOnLoad] only ran once at domain load
        // and won't run again, so the map is never re-written —
        // no accumulation or duplicate-key problem

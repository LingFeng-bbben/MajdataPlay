...
/*    private void LoadSkin()
    ...
    public void PlayEffect(int position, bool isBreak,DataTypes.TapJudgeType judgeType)
    {
        var pos = position - 1;
        
        if (judgeType == DataTypes.TapJudgeType.CPerfect ||
            judgeType == DataTypes.TapJudgeType.FastPerfect ||
            judgeType == DataTypes.TapJudgeType.LatePerfect)
        {

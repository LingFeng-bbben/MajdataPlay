...
public class WifiDrop : NoteLongDrop,IFlasher
{
    ...
    void Judge()
    {
        ...
        else if (arriveTime < starTiming && gamePlayManager.AudioTime >= starTiming + stayTime * 0.667)
            DestroySelf();
        else if (arriveTime >= starTiming && gamePlayManager.AudioTime >= arriveTime + stayTime * 0.667)
            DestroySelf();
    }

...
namespace MajdataPlay.List
{
    public class ListManager : MonoBehaviour
    {
        ...
        void ButtonDownCheck()
        {
            ...
            if (InputManager.CheckButtonStatusInThisFrame(SensorArea.A3, SwitchStatus.On))
            {
                if (!_isPressed)
                {
                    _coverListDisplayer.SlideList(1);
            ...
            else if (InputManager.CheckButtonStatusInThisFrame(SensorArea.A6, SwitchStatus.On))
            {
                if (!_isPressed)
                {
                    _coverListDisplayer.SlideList(-1);
            ...
            if (InputManager.CheckButtonStatusInThisFrame(SensorArea.A4, SwitchStatus.On))
            {
            ...
            else if (InputManager.CheckButtonStatusInThisFrame(SensorArea.A5, SwitchStatus.On))
            {
            ...
            if (InputManager.CheckButtonStatusInThisFrame(SensorArea.P1, SwitchStatus.On))
            {
                MajInstances.SceneSwitcher.SwitchScene("SortFind");
                _isExited = true;
                return;
            }
            else if (InputManager.CheckButtonStatusInThisFrame(SensorArea.A2, SwitchStatus.On))
            {
            ...
            else if (InputManager.CheckButtonStatusInThisFrame(SensorArea.A7, SwitchStatus.On))
            {
        ...
        void ButtonUpCheck()
        {
            ...
            var isA3Up = InputManager.CheckButtonStatusInPreviousFrame(SensorArea.A3, SwitchStatus.On) &&
                         InputManager.CheckButtonStatusInThisFrame(SensorArea.A3, SwitchStatus.Off);
            var isA4Up = InputManager.CheckButtonStatusInPreviousFrame(SensorArea.A4, SwitchStatus.On) &&
                         InputManager.CheckButtonStatusInThisFrame(SensorArea.A4, SwitchStatus.Off);
            var isA6Up = InputManager.CheckButtonStatusInPreviousFrame(SensorArea.A6, SwitchStatus.On) && 
                         InputManager.CheckButtonStatusInThisFrame(SensorArea.A6, SwitchStatus.Off);
